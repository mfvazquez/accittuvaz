...
\cline{1-5}
\multicolumn{1}{ |c  }{\multirow{2}{*}{$I_{D_{SAT}} \simeq 0,5 \unit{mA}$} } & \multicolumn{1}{ |c| }{ $\displaystyle \abs{\frac{r_{o_{X}} - r_{o_{modelo\ modificado}}}{r_{o_{modelo\ modificado}}}} \ 100 \%$} & $\%$ & $\%$ & $\%$ &   \\ 
\cline{2-5}
\multicolumn{1}{ |c  }{}                        & \multicolumn{1}{ |c| }{$ \displaystyle \abs{\frac{\lambda_{X} - \lambda_{modelo\ modificado}}{\lambda_{modelo\ modificado}}} \ 100 \%$} & $\%$ & $\%$ & $\%$ &   \\ 
\cline{1-5}
\multicolumn{1}{ |c  }{\multirow{2}{*}{$I_{D_{SAT}} \simeq 2,5 \unit{mA}$} } & \multicolumn{1}{ |c| }{ $\displaystyle \abs{\frac{r_{o_{X}} - r_{o_{modelo\ modificado}}}{r_{o_{modelo\ modificado}}}} \ 100 \%$} & $\%$ & $\%$ & $\%$ & \\ 
\cline{2-5}
\multicolumn{1}{ |c  }{}                        & \multicolumn{1}{ |c| }{$ \displaystyle \abs{\frac{\lambda_{X} - \lambda_{modelo\ modificado}}{\lambda_{modelo\ modificado}}} \ 100 \%$} & $\%$ & $\%$ & $\%$ &\\ 
\cline{1-5}
\end{tabular}
