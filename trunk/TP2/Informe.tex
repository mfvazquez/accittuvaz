...
Para la obtención de la resistencia $R_{B1}$ planteamos la ecuación \ref{eq:RB1} obtenida del circuito mostrado en la figura \ref{circuito:medicion_salida}.

\begin{equation}
R_{B1} = \frac{V_{DD} - V_{BE_{ON}}}{I_B}
\label{eq:RB1}
\end{equation}
