...
Simulacion1=dlmread('tbjphillips(ICvsVCE)5mA.txt','\t',1,0);
Simulacion2=dlmread('tbjsiemens(ICvsVCE)5mA.txt','\t',1,0);
Simulacion3=dlmread('tbjpropio(ICvsVCE)5mA.txt','\t',1,0);
...
axis([0 5000 4.1 5.3])
grid minor
print('IcvsVce_5mA.tex','-depslatexstandalone');
