...
Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion1(end-5:end,:)');
ro_medicion1=1/Param(1)
ID_medicion1=Param(2)
lambda_medicion1=(1/ro_medicion1)/(ID_medicion1)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion2(end-5:end,:)');
ro_medicion2=1/Param(1)
ID_medicion2=Param(2)
lambda_medicion2=(1/ro_medicion2)/(ID_medicion2)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion3(end-5:end,:)');
ro_medicion3=1/Param(1)
ID_medicion3=Param(2)
lambda_medicion3=(1/ro_medicion3)/(ID_medicion3)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],simulacion1(end-20:end,:)');
ro_simulacion1=1/Param(1)
ID_simulacion1=Param(2)
lambda_simulacion1=(1/ro_simulacion1)/(ID_simulacion1)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],simulacion2(end-20:end,:)');
...
plot(V(inicio:end),((V/ro_medicion1)+ID_medicion1)(inicio:end),'r-','Linewidth',1)
plot(V(inicio:end),((V/ro_medicion2)+ID_medicion2)(inicio:end),'g-','Linewidth',1)
plot(V(inicio:end),((V/ro_medicion3)+ID_medicion3)(inicio:end),'b-','Linewidth',1)

legend(sprintf('M1 ro = %f kOhm y lambda = %f 1/V',ro_medicion1, lambda_medicion1),
	   sprintf('M3 ro = %f kOhm y lambda = %f 1/V',ro_medicion2, lambda_medicion2),
	   sprintf('M5 ro = %f kOhm y lambda = %f 1/V',ro_medicion3, lambda_medicion3),
