...
Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion1(1:4,:)');
ro_medicion1=1/Param(1)
ID_medicion1=Param(2)
lambda_medicion1=(-1/ro_medicion1)/(ID_medicion1)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion2(1:4,:)');
ro_medicion2=1/Param(1)
ID_medicion2=Param(2)
lambda_medicion2=(-1/ro_medicion2)/(ID_medicion2)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion3(1:4,:)');
