...
Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion1(end-10:end,:)');
ro_medicion1=1/Param(1)
ID_medicion1=Param(2)
lambda_medicion1=(1/ro_medicion1)/(ID_medicion1)

Param=fmins('A_x_mas_B',[0.04 -0.5],[0,0.0001,0,0,0,0,0,0,0,],[],medicion2(end-10:end,:)');
